/***************************************************************************************
 **  controladorGenericoDouble.c - Funciones relativas a los controladores genericos
 ...
 ** AREA DE INCLUDES                                                                   **
 ****************************************************************************************/
#include "controlador_genericoDouble.h"
 ...
 **  Retorno:        Ninguno
 ****************************************************************************************/
void iniciarControladorGenericoD(controladorGenericoD_t *controlador, double *numC, double *denC, int8_t n, double limSalida, double frec)
{
    int8_t i;
    for (i=0;i<10;i++){
        if (i<n){
    ...
    resetearControladorGenericoD(controlador);
}
